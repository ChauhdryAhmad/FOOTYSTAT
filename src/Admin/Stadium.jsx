...
import './Adminstyle/stadium.css'; // Import the CSS file
...
const Stadium = () => {
  ...
  return (
    <div className="stadium-container">
          ...
          {stadiums.map((stadium) => {
            ...
            return (
              <tr key={stadium.id}>
                ...
                <td>
                  <button className="delete-button" onClick={() => handleDelete(stadium.id)}>Delete</button>
                  <button className="update-button" onClick={() => handleUpdate(stadium)}>Update</button>
                </td>
              </tr>
            );
          })}
      ...
      <br />
      <button className="add-stadium-button" onClick={() => {
