...
import './Adminstyle/transfer.css'; // Import the CSS file
...
const Transfer = () => {
  ...
  return (
    <div className="transfer-container">
        ...
        <tbody>
          {transfers.map((transfer) => (
            <tr key={transfer.id}>
              ...
              <td>
                <button className="delete-button" onClick={() => handleDelete(transfer.id)}>Delete</button>
                <button className="update-button" onClick={() => handleUpdate(transfer)}>Update</button>
              </td>
            </tr>
          ))}
        </tbody>
      ...
      <br />
      <button className="add-transfer-button" onClick={() => {
