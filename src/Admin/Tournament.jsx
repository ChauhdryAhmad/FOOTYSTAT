...
import "./Adminstyle/tournament.css";
...
const Tournament = () => {
  ...
  return (
    <div className="tournament-container">
        ...
        <tbody>
          {tournaments.map((tournament) => (
            <tr key={tournament.id}>
              ...
              <td>
                <button className="delete-button" onClick={() => handleDelete(tournament.id)}>Delete</button>
                <button className="update-button" onClick={() => handleUpdate(tournament)}>Update</button>
              </td>
            </tr>
          ))}
        </tbody>
      ...
      <br />
      <button className="add-tournament-button" onClick={() => {
