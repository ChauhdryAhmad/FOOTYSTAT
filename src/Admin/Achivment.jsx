...
import './Adminstyle/achivment.css'; // Import the CSS file
        ...
        <tbody>
          {achievements.map((achievement) => (
            <tr key={achievement.id}>
              ...
              <td>
                <button className="delete-button" onClick={() => handleDelete(achievement.id)}>Delete</button>
                <button className="update-button" onClick={() => handleUpdate(achievement)}>Update</button>
              </td>
            </tr>
          ))}
        </tbody>
