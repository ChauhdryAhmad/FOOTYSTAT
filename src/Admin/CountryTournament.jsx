...
import "./Adminstyle/countrytournament.css";
...
const CountryTournament = () => {
  ...
  return (
    <div className="countrytournament-container">
        ...
        <tbody>
          {countryTournaments.map((countryTournament) => (
            <tr key={countryTournament.id}>
              ...
              <td>
                <button className="delete-button" onClick={() => handleDelete(countryTournament.id)}>Delete</button>
                <button className="update-button" onClick={() => handleUpdate(countryTournament)}>Update</button>
              </td>
            </tr>
          ))}
        </tbody>
      ...
      <br />
      <button className="add-countrytournament-button" onClick={() => {
      ...
      {showForm && (
        <div className="countrytournament-form-container">
