...
import "./Adminstyle/teammanager.css";
...
const TeamManager = () => {
  ...
  return (
    <div className="teammanager-container">
      <h2>Team Managers</h2>
        ...
        <tbody>
          {teamManagers.map((teamManager) => (
            <tr key={teamManager.id}>
              ...
              <td>
                <button className="delete-button" onClick={() => handleDelete(teamManager.id)}>Delete</button>
                <button classname="update-button" onClick={() => handleUpdate(teamManager)}>Update</button>
              </td>
            </tr>
          ))}
        </tbody>
      ...
      <br />
      <button classname="add-teammanger-button" onClick={() => {
      ...
      {showForm && (
        <div className="teammanager-form-container">
