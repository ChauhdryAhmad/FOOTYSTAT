...
import './Adminstyle/playerclubstat.css'; // Import the CSS file
...
const PlayerClubStat = () => {
  ...
  return (
    <div className="playerclubstat-container">
          ...
          {playerClubStats.map((playerClubStat) => {
            ...
            return (
              <tr key={playerClubStat.id}>
                ...
                <td>{playerClubStat.endYear ? "-" : "Current Year"}</td>
                <td>
                  <button className="delete-button" onClick={() => handleDelete(playerClubStat.id)}>Delete</button>
                  <button className="update-button" onClick={() => handleUpdate(playerClubStat)}>Update</button>
                </td>
              </tr>
            );
          })}
      ...
      <br />
      <button className="add-playerclubstat-button" onClick={() => {
      ...
      {showForm && (
        <div className="playerclubstat-form-container">
