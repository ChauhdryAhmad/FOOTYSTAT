...
import './Adminstyle/achivmentplayer.css'; // Import the CSS file
...
const AchievementPlayer = () => {
  ...
  return (
    <div className="achivmentplayer-container">
          ...
          {achievementPlayers.map((achievementPlayer) => {
            ...
            return (
              <tr key={achievementPlayer.id}>
                ...
                <td>
                  <button className="delete-button" onClick={() => handleDelete(achievementPlayer.id)}>Delete</button>
                  <button className="update-button" onClick={() => handleUpdate(achievementPlayer)}>Update</button>
                </td>
              </tr>
            );
          })}
      ...
      <br />
      <button className="add-achivment-button" onClick={() => {
      ...
      {showForm && (
        <div className="achivment-form-container">
