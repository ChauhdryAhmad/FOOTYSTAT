...
import "./Adminstyle/teamsponsor.css";
...
const SponsorTeam = () => {
  ...
  return (
    <div className="teamsponsor-container">
      <h2>Sponsor Teams</h2>
        ...
        <tbody>
          {sponsorTeams.map((sponsorTeam) => (
            <tr key={sponsorTeam.id}>
              ...
              <td>
                <button className="delete-button" onClick={() => handleDelete(sponsorTeam.id)}>Delete</button>
                <button className="update-button" onClick={() => handleUpdate(sponsorTeam)}>Update</button>
              </td>
            </tr>
          ))}
        </tbody>
      ...
      <br />
      <button className="add-teamsponsor-button" onClick={() => {
      ...
      {showForm && (
        <div className="teamsponsor-form-container">
